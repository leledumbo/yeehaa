{hint: Pascal files location: .../androiddemo/jni }
library yeehaaandroid;  //[by LAMW: Lazarus Android Module Wizard: 24/02/22 18:22:32]
...
uses
  ...
  Laz_And_Controls_Events, lnetbase, modmain;
...
begin
  Java_Event_pAppOnCreate(PEnv, this, context, layout, intent); AMMain.ReInit(
    gApp);
end;
...
begin
  ...
  begin
     curEnv := PJNIEnv(PEnv);
     RegisterNativeMethods(curEnv, 'org/leledumbo/androiddemo/Controls');
  end;
...
exports
  ...
  pAppOnScreenStyle name 'Java_org_leledumbo_androiddemo_Controls_'
    +'pAppOnScreenStyle',
  pAppOnNewIntent name
    'Java_org_leledumbo_androiddemo_Controls_pAppOnNewIntent',
  pAppOnDestroy name 'Java_org_leledumbo_androiddemo_Controls_pAppOnDestroy',
  pAppOnPause name 'Java_org_leledumbo_androiddemo_Controls_pAppOnPause',
  pAppOnRestart name 'Java_org_leledumbo_androiddemo_Controls_pAppOnRestart',
  pAppOnResume name 'Java_org_leledumbo_androiddemo_Controls_pAppOnResume',
  pAppOnStart name 'Java_org_leledumbo_androiddemo_Controls_pAppOnStart',
  pAppOnStop name 'Java_org_leledumbo_androiddemo_Controls_pAppOnStop',
  pAppOnBackPressed name 'Java_org_leledumbo_androiddemo_Controls_'
    +'pAppOnBackPressed',
  pAppOnRotate name 'Java_org_leledumbo_androiddemo_Controls_pAppOnRotate',
  pAppOnUpdateLayout name 'Java_org_leledumbo_androiddemo_Controls_'
    +'pAppOnUpdateLayout',
  pAppOnConfigurationChanged name 'Java_org_leledumbo_androiddemo_Controls_'
    +'pAppOnConfigurationChanged',
  pAppOnActivityResult name 'Java_org_leledumbo_androiddemo_Controls_'
    +'pAppOnActivityResult',
  pAppOnCreateOptionsMenu name 'Java_org_leledumbo_androiddemo_Controls_'
    +'pAppOnCreateOptionsMenu',
  pAppOnClickOptionMenuItem name 'Java_org_leledumbo_androiddemo_Controls_'
    +'pAppOnClickOptionMenuItem',
  pAppOnPrepareOptionsMenu name 'Java_org_leledumbo_androiddemo_Controls_'
    +'pAppOnPrepareOptionsMenu',
  pAppOnPrepareOptionsMenuItem name 'Java_org_leledumbo_androiddemo_Controls_'
    +'pAppOnPrepareOptionsMenuItem',
  pAppOnCreateContextMenu name 'Java_org_leledumbo_androiddemo_Controls_'
    +'pAppOnCreateContextMenu',
  pAppOnClickContextMenuItem name 'Java_org_leledumbo_androiddemo_Controls_'
    +'pAppOnClickContextMenuItem',
  pOnDraw name 'Java_org_leledumbo_androiddemo_Controls_pOnDraw',
  pOnTouch name 'Java_org_leledumbo_androiddemo_Controls_pOnTouch',
  pOnClickGeneric name
    'Java_org_leledumbo_androiddemo_Controls_pOnClickGeneric',
  pAppOnSpecialKeyDown name 'Java_org_leledumbo_androiddemo_Controls_'
    +'pAppOnSpecialKeyDown',
  pOnDown name 'Java_org_leledumbo_androiddemo_Controls_pOnDown',
  pOnUp name 'Java_org_leledumbo_androiddemo_Controls_pOnUp',
  pOnClick name 'Java_org_leledumbo_androiddemo_Controls_pOnClick',
  pOnLongClick name 'Java_org_leledumbo_androiddemo_Controls_pOnLongClick',
  pOnDoubleClick name 'Java_org_leledumbo_androiddemo_Controls_pOnDoubleClick',
  pOnChange name 'Java_org_leledumbo_androiddemo_Controls_pOnChange',
  pOnChanged name 'Java_org_leledumbo_androiddemo_Controls_pOnChanged',
  pOnEnter name 'Java_org_leledumbo_androiddemo_Controls_pOnEnter',
  pOnBackPressed name 'Java_org_leledumbo_androiddemo_Controls_pOnBackPressed',
  pOnClose name 'Java_org_leledumbo_androiddemo_Controls_pOnClose',
  pAppOnViewClick name
    'Java_org_leledumbo_androiddemo_Controls_pAppOnViewClick',
  pAppOnListItemClick name 'Java_org_leledumbo_androiddemo_Controls_'
    +'pAppOnListItemClick',
  pOnFlingGestureDetected name 'Java_org_leledumbo_androiddemo_Controls_'
    +'pOnFlingGestureDetected',
  pOnPinchZoomGestureDetected name 'Java_org_leledumbo_androiddemo_Controls_'
    +'pOnPinchZoomGestureDetected',
  pOnLostFocus name 'Java_org_leledumbo_androiddemo_Controls_pOnLostFocus',
  pOnFocus name 'Java_org_leledumbo_androiddemo_Controls_pOnFocus',
  pOnBeforeDispatchDraw name 'Java_org_leledumbo_androiddemo_Controls_'
    +'pOnBeforeDispatchDraw',
  pOnAfterDispatchDraw name 'Java_org_leledumbo_androiddemo_Controls_'
    +'pOnAfterDispatchDraw',
  pOnLayouting name 'Java_org_leledumbo_androiddemo_Controls_pOnLayouting',
...
begin
  ...
  gjAppName:= 'org.leledumbo.androiddemo';
  gjClassName:= 'org/leledumbo/androiddemo/Controls';
  gApp.AppName:=gjAppName;
  gApp.ClassName:=gjClassName;
  gApp.Initialize;
  gApp.CreateForm(TAMMain, AMMain);
end.
